...
- [Findings](#findings)
  - [Observation 1 — <invalid> reproduces deterministically](#observation-1--invalid-reproduces-deterministically)
  - [Observation 2 — kubectl get -o yaml shows correct data](#observation-2--kubectl-get--o-yaml-shows-correct-data)
  - [Observation 3 — kubectl source path (TBD)](#observation-3--kubectl-source-path-tbd)
  - [Observation 4 — Other date-typed columns audited (TBD)](#observation-4--other-date-typed-columns-audited-tbd)
