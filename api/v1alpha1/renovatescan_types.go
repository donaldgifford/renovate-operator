...
type RenovateScanSpec struct {
	...
	// foo is an example field of RenovateScan. Edit renovatescan_types.go to remove/update
	// +optional
...
type RenovateScanStatus struct {
	...
	// conditions represent the current state of the RenovateScan resource.
